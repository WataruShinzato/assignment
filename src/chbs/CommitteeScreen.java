...
public class CommitteeScreen extends JFrame implements ActionListener{      // Action after login
    public void actionPerformed(ActionEvent e){
        if(e.getSource() == logout){                              // action when you push logout button
            ...
            System.out.println(DataIO.allBookings.size());
            ...
            MyCustomer updatedMyData = new MyCustomer(inputName, password);  // assign inputname and password to Mycustomer method
            // MyCustomer.set(0, y);
            ...
            JOptionPane.showMessageDialog(viewreservation,strday + " " + strid + " "+ strtime +" "+ strconsul +" "+ strname); // display booking information
